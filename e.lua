...
rconsolename("Purpware External")
function aorimain()
aorinjectbase([[
                     ...
                     $$ |      $$ |  $$ |$$ |      $$ |  $$ |$$ | $$ | $$ |$$  __$$ |$$ |      $$   ____|
                     $$ |      \$$$$$$  |$$ |      $$$$$$$  |\$$$$$\$$$$  |\$$$$$$$ |$$ |      \$$$$$$$\ 
                     \__|       \______/ \__|      $$  ____/  \_____\____/  \_______|\__|       \_______|
                                                   $$ |                                                  
                                                   $$ |                                                  
                                                   \__|                                                      
                  ...
                  Type 1 and press enter to load, Make sure to customize your settings!


                                        [1] Load Purpware []] ..aorinjectstatus ..[[]
                                        [2] Camlock Settings
...
function aoriresponse()
    ...
    elseif aori == "X" or aori == "x" then
        game.Players.LocalPlayer:Kick("Purpware Overload Kick")
    elseif aori == "2" then
        rconsoleclear()
        aoricammiscs()
    elseif aori == "3" then
